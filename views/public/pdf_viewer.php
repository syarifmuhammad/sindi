...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
	...
	<?=link_tag('assets/plugins/pdf_viewer/viewer.css');?>

    <script src="<?=base_url('assets/plugins/pdf_viewer/compatibility.js');?>"></script>


<link rel="resource" type="application/l10n" href="<?=base_url('assets/plugins/pdf_viewer/locale/locale.properties');?>">
<script src="<?=base_url('assets/plugins/pdf_viewer/l10n.js');?>"></script>
<script src="<?=base_url('assets/plugins/pdf_viewer/pdf.js');?>"></script>


<script>
'use strict';
var DEFAULT_URL = "<?=base_url('public/pdf_viewer/pdf_content/'.$folder.'/'.$file_name);?>";
;
var pdfjsWebLibs;
{
 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function getPDFFileNameFromURL(url) {
    ...
    return suggestedFilename || "<?=$title;?>.pdf";
   }
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    PDFJS.imageResourcesPath = "<?=base_url('assets/plugins/pdf_viewer/images/');?>";
    PDFJS.workerSrc = "<?=base_url('assets/plugins/pdf_viewer/pdf.worker.js');?>";
    PDFJS.cMapUrl = "<?=base_url('assets/plugins/pdf_viewer/cmaps/');?>";
