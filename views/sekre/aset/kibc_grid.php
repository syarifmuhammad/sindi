            ...
            <table border="2px" class="table table-hover table-sm table-striped table-condensed" id="printTable">
               <thead>
				  <tr>
					...
					<th rowspan="2"><center><small>Jenis Barang / Nama<br>Barang</small></center></th>
					<th colspan="2"><center><small>Nomor</small></center></th>
					<th rowspan="2"><center><small>Kondisi <br> Bangunan <br> (B, KB, RB)</small></center></th>
					<th colspan="2"><center><small>Konstruksi Bangunan</small></center></th>
					<th rowspan="2"><center><small>Luas Lantai <br> (m2)</small></center></th>
					<th rowspan="2"><center><small>Letak / <br> Lokasi <br> Alamat</small></center></th>
					<th colspan="2"><center><small>Dokumen Gedung</small></center></th>
					<th rowspan="2"><center><small>Luas (m2)</small></center></th>
					<th rowspan="2"><center><small>Status <br> Tanah</small></center></th>
					<th rowspan="2"><center><small>Nomor Kode <br> Tanah</small></center></th>
				  ...
				  <tr>
					<th><center><small>Kode Barang</small></center></th>
					<th><center><small>Register</small></center></th>
					<th><center><small>Bertingkat / Tidak</small></center></th>
					<th><center><small>Beton /<br> Tidak</small></center></th>
