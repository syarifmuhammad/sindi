      ...
      <div class="box-body">
		 ...
		 <div class="table-responsive">
            <table border="2px" class="table table-hover table-sm table-striped table-condensed" id="printTable">
               <thead>
				  <tr>
					<th rowspan="3" data-sort="ASC" width="30px"><center><small>No</small></center></th>
					<th rowspan="3" class="exclude_excel" data-sort="ASC" width="30px"><center><input type="checkbox" class="check-all"></center></th>
					<th rowspan="3" class="exclude_excel" data-sort="ASC" width="30px"><center><i class="fa fa-edit"></i></center></th>
					<th rowspan="3"><center><small>Jenis Barang / Nama<br>Barang</small></center></th>
					<th colspan="2"><center><small>Nomor</small></center></th>
					<th rowspan="3"><center><small>Luas (m2)</small></center></th>
					<th rowspan="3"><center><small>Tahun<br>Pengadaan</small></center></th>
					<th rowspan="3"><center><small>Letak / <br>Alamat</small></center></th>
					<th colspan="3"><center><small>Status Tanah</small></center></th>
					<th rowspan="3"><center><small>Penggunaan</small></center></th>
					<th rowspan="3"><center><small>Asal Usul</small></center></th>
					<th rowspan="3"><center><small>Harga (Rp)</small></center></th>
					<th rowspan="3"><center><small>Keterangan</small></center></th>
				  </tr>
				  <tr>
					<th rowspan="2"><center><small>Kode Barang</small></center></th>
					<th rowspan="2"><center><small>Register</small></center></th>
					<th rowspan="2"><center><small>Hak</small></center></th>
					<th colspan="2"><center><small>Sertifikat</small></center></th>
				  </tr>
				  <tr>
