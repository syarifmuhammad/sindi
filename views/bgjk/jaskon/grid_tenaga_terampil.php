            ...
            <table border="2px" class="table table-hover table-sm table-striped table-condensed" id="printTable">
               <thead>
				  <tr>
					...
					<th rowspan="2"><center><small>Nama Tenaga Terampil</small></center></th>
					<th rowspan="2"><center><small>NIK</small></center></th>
					<th rowspan="2"><center><small>Jenis Kelamin</small></center></th>
					<th rowspan="2"><center><small>Alamat</small></center></th>
					<th colspan="4"><center><small>SKT</small></center></th>
					<th rowspan="2"><center><small>No. Telpon</small></center></th>
				  ...
				  <tr>
					...
					<th><center><small>Jenis<br>Keterampilan</small></center></th>
