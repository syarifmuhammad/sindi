...
class Modulesr extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Daftar Modul Non Aktif';
		$this->vars['users'] = $this->vars['modules'] = true;
		$this->vars['content'] = 'modules/readr';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_modules->get_where_del($keyword, $limit, $offset);
			$total_rows = $this->m_modules->total_rows_del($keyword);
