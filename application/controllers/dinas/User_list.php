...
class User_list extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('dinas/m_user_list');
		$this->pk = M_user_list::$pk;
		$this->table = M_user_list::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'Admin Sekolah';
		$this->vars['userlp'] = $this->vars['user_list'] = true;
		$this->vars['content'] = 'dinas/user_list';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_user_list->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_user_list->total_rows($keyword);
