...
class Air_minum extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('ampl/m_air_minum');
		$this->pk = M_air_minum::$pk;
		$this->table = M_air_minum::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'Air Minum';
		$this->vars['ampl'] =  $this->vars['air_minum'] = true;
		$this->vars['content'] = 'ampl/air_minum';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_air_minum->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_air_minum->total_rows($keyword);
